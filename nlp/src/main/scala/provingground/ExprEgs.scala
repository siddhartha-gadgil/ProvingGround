...
object ExprEgs{
  val assertions =
    Vector(
      ...
      "If $G/H$ is cyclic, then $G$ is abelian", // useless 'then' causing trouble
      ...
      "Two quadratic forms over $k$ are equivalent and they have the same rank", //experiment iff -> and
