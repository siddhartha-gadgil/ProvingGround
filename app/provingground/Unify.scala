...
object Unify{
  ...
  def mkLambda[U <: Term with Subs[U] : TypeTag, V<: Term with Subs[V] : TypeTag]: FuncTerm[U, V] => FuncTerm[U, V] = {
  ...
  def mkLmbda[U <: Term with Subs[U] : TypeTag, V<: Term with Subs[V] : TypeTag] :FuncObj[U, V] => FuncObj[U, V] = {
