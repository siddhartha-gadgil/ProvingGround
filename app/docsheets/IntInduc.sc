...
object IntInduc {
  ...
  val three = N.rep(3)                            //> three  : provingground.functionfinder.ScalaRep.SimpleConst[Long] = 3
	...
	recN                                      //> res6: provingground.HoTT.FuncTerm[provingground.HoTT.Typ[provingground.HoTT.
                                                  ...
                                                  //| d.HoTT.Subs[provingground.HoTT.Term],provingground.HoTT.FuncObj[provinggroun
                                                  //| d.HoTT.FuncObj[provingground.HoTT.Term,provingground.HoTT.FuncObj[provinggro
                                                  //| und.HoTT.Term,provingground.HoTT.Term]] with provingground.HoTT.Subs[proving
                                                  //| ground.HoTT.FuncObj[provingground.HoTT.Term,provingground.HoTT.FuncObj[provi
                                                  //| ngground.HoTT.Term,provingground.HoTT.Term]]],provingground.HoTT.FuncObj[pro
                                                  //| vingground.HoTT.Term,provingground.HoTT.Term]]]] = (A|->(((a : A) : A)|->((p
                                                  //| rovingground.HoTT$Typ$newname$2$@4fce7ceb : (N->(A->A)))|-><function1>)))
	
	recN(N)                                   //> res7: provingground.HoTT.FuncObj[provingground.HoTT.Term with provingground.
                                                  //| HoTT.Subs[provingground.HoTT.Term],provingground.HoTT.FuncObj[provingground.
                                                  //| HoTT.FuncObj[provingground.HoTT.Term,provingground.HoTT.FuncObj[provinggroun
                                                  //| d.HoTT.Term,provingground.HoTT.Term]] with provingground.HoTT.Subs[provinggr
                                                  //| ound.HoTT.FuncObj[provingground.HoTT.Term,provingground.HoTT.FuncObj[proving
                                                  //| ground.HoTT.Term,provingground.HoTT.Term]]],provingground.HoTT.FuncObj[provi
                                                  //| ngground.HoTT.Term,provingground.HoTT.Term]]] = (((a : A) : N)|->((provinggr
                                                  //| ound.HoTT$Typ$newname$2$@4fce7ceb : (N->(N->N)))|-><function1>))
	
	recN(N).typ                               //> res8: provingground.HoTT.Typ[provingground.HoTT.Term] = (N->((N->(N->N))->(N
                                                  //| ->A)))
	
	val recc = recN(N)                        //> recc  : provingground.HoTT.FuncObj[provingground.HoTT.Term with provinggroun
                                                  //| d.HoTT.Subs[provingground.HoTT.Term],provingground.HoTT.FuncObj[provinggroun
                                                  //| d.HoTT.FuncObj[provingground.HoTT.Term,provingground.HoTT.FuncObj[provinggro
                                                  //| und.HoTT.Term,provingground.HoTT.Term]] with provingground.HoTT.Subs[proving
                                                  //| ground.HoTT.FuncObj[provingground.HoTT.Term,provingground.HoTT.FuncObj[provi
                                                  //| ngground.HoTT.Term,provingground.HoTT.Term]]],provingground.HoTT.FuncObj[pro
                                                  //| vingground.HoTT.Term,provingground.HoTT.Term]]] = (((a : A) : N)|->((proving
                                                  //| ground.HoTT$Typ$newname$2$@4fce7ceb : (N->(N->N)))|-><function1>))
	
	val fn = recc(N.rep(0))(N.sum)            //> fn  : provingground.HoTT.FuncObj[provingground.HoTT.Term,provingground.HoTT.
                                                  //| Term] = <function1>
	
	fn(N.rep(0))                              //> res9: provingground.HoTT.Term = (a : A)
	
	fn(three)                                 //> res10: provingground.HoTT.Term = (((f : (N->(A->A)))(1) : (A->A))((((f : (N-
                                                  //| >(A->A)))(2) : (A->A))((((f : (N->(A->A)))(3) : (A->A))((a : A)) : A)) : A))
                                                  //|  : A)
	
	fn.typ                                    //> res11: provingground.HoTT.Typ[provingground.HoTT.Term] = (N->A)
	
	fn(three).typ                             //> res12: provingground.HoTT.Typ[provingground.HoTT.Term] = A
  ...
  fnrep((k: Long) => N.rep(k))                    //> res19: provingground.HoTT.FuncObj[provingground.HoTT.Term,provingground.HoT
	...
	idrep((k: Long) => 2 *k)(three)           //> res22: provingground.HoTT.Term = 6
	...
	addrep(add)(three)(three)                 //> res23: provingground.HoTT.Term = 6
	...
	recrep.domrep                             //> res24: provingground.functionfinder.ScalaRep.ScalaRep[provingground.HoTT.Te
                                                  //| rm,provingground.HoTT.Term] = IdRep(N)
	
	recrep.codomrep                           //> res25: provingground.functionfinder.ScalaRep.ScalaRep[provingground.HoTT.Fu
	...
	recrep.domrep.unapply(N.rep(0))           //> res26: Option[provingground.HoTT.Term] = Some(0)
	...
	val readd =  addrep.unapply(addterm).get  //> readd  : Long => (provingground.HoTT.Term => provingground.HoTT.Term) = <fu
                                                  //| nction1>
	readd(3)(six)                             //> res27: provingground.HoTT.Term = 9
	
	recrep(ind)                               //> res28: provingground.HoTT.FuncObj[provingground.HoTT.Term,provingground.HoT
	...
	recrep(ind)(N.rep(0))                     //> res29: provingground.HoTT.FuncObj[provingground.HoTT.FuncObj[provingground.
	...
	codrep.unapply(recrep(ind)(N.rep(0)))     //> res30: Option[(Long => (provingground.HoTT.Term => provingground.HoTT.Term)
                                                  //| ) => (Long => provingground.HoTT.Term)] = Some(<function1>)
	
	fnrep.unapply(recrep(ind)(N.rep(0))(N.sum))
                                                  //> res31: Option[Long => provingground.HoTT.Term] = None
	
	fnrep.unapply(recrep(ind)(N.rep(0))(Nsum))//> res32: Option[Long => provingground.HoTT.Term] = None
	
	//
	// This is the crucial problem - the matching for extended functions matched codomrep.
	//
	addrep.unapply(Nsum)                      //> res33: Option[Long => (provingground.HoTT.Term => provingground.HoTT.Term)]
                                                  //|  = None
	...
	recrep(ind).typ                           //> res34: provingground.HoTT.Typ[provingground.HoTT.Term] = (N->((N->(N->N))->
                                                  //| (N->N)))

	recrep(ind)(N.rep(0))                     //> res35: provingground.HoTT.FuncObj[provingground.HoTT.FuncObj[provingground.
                                                  //| HoTT.Term,provingground.HoTT.FuncObj[provingground.HoTT.Term,provingground.
                                                  //| HoTT.Term]],provingground.HoTT.FuncObj[provingground.HoTT.Term,provinggroun
                                                  //| d.HoTT.Term]] = <function1>
	...
	toapply.asInstanceOf[FuncSymb[Term, Term]]//> res36: provingground.HoTT.FuncSymb[provingground.HoTT.Term,provingground.Ho
                                                  //| TT.Term] = (<function1>(<function1>) : (N->N))


	// The correct sum to use
	recrep(ind)(N.rep(0))(addrep(add))(three) //> res37: provingground.HoTT.Term = 6

	// toapply.asInstanceOf[FuncSymb[Term, Term]]

	recrep(ind)(N.rep(0))(N.sum)(N.rep(5))    //> res38: provingground.HoTT.Term = ((<function1>(<function1>) : (N->N))(5) : 
                                                  //| N)

	recrep(ind)(N.rep(0))(N.sum)(N.rep(5)).typ//> res39: provingground.HoTT.Typ[provingground.HoTT.Term] = N


	// This is still wrong.
	recrep(ind)(N.rep(0))(N.sum)(three)       //> res40: provingground.HoTT.Term = ((<function1>(<function1>) : (N->N))(3) : 
                                                  //| N)
...
//	val idrep = n -->: n
	...
	idrep((k: Long) => 2 *k)(three)           //> res41: provingground.HoTT.Term = 6

	val NN = IdRep(N)                         //> NN  : provingground.functionfinder.ScalaRep.IdRep[provingground.HoTT.Term] 
                                                  //| = IdRep(N)
	
	NN(three)                                 //> res42: provingground.HoTT.Term = 3
	...
	r((k: Long) => N.rep(k))(three)           //> res43: provingground.HoTT.Term = 3
	...
	rsum(three)(three)                        //> res44: provingground.HoTT.Term = 6
	...
	evalout(N.rep(_))                         //> res45: provingground.HoTT.Term = 1
	...
	rfn.asInstanceOf[ExtendedFunction[Term, Long, Term, Term]]
                                                  //> res46: provingground.functionfinder.ScalaRep.ExtendedFunction[provingground
                                                  //| .HoTT.Term,Long,provingground.HoTT.Term,provingground.HoTT.Term] = <functio
                                                  //| n1>
	
	eval(rfn)                                 //> res47: provingground.HoTT.Term = 2
	
	eval(rfn) == N.rep(2)                     //> res48: Boolean = true
