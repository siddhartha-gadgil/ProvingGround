...
abstract class IndexedConstructorShape[
    S <: HList,
    H <: Term with Subs[H],
    Fb <: Term with Subs[Fb],
    ConstructorType <: Term with Subs[ConstructorType],
...
object IndexedConstructorShape {
  ...
  case class IndexedFuncConsShape[HShape <: HList,
      ...
      extends IndexedConstructorShape[
          IndexedFuncConsShape.type :: HShape, H, F, Func[FI, HC], Index] {
  ...
  case class IndexedCnstFuncConsShape[HShape <: HList,
      ...
      extends IndexedConstructorShape[
          IndexedCnstFuncConsShape.type :: HShape, H, F, Func[T, HC], Index] {
...
object IndexedConstructorPatternMapper {
  ...
  implicit def indexedIdMapper[C <: Term with Subs[C], H <: Term with Subs[H], F <: Term with Subs[
          F], Index <: HList : Subst, IF <: Term with Subs[IF], IDF <: Term with Subs[
          IDF], IDFT <: Term with Subs[IDFT]](
  ...
  implicit def indexedCnstFncPtnMapper[
      HShape <: HList, T <: Term with Subs[T], Cod <: Term with Subs[Cod], HC <: Term with Subs[
          HC], H <: Term with Subs[H], HR <: Term with Subs[HR], HI <: Term with Subs[
          HI], Fb <: Term with Subs[Fb], Index <: HList : Subst, IF <: Term with Subs[
          IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
  ...
  implicit def indexedCnstDepFncPtnMapper[HShape <: HList, T <: Term with Subs[
          T], Cod <: Term with Subs[Cod], HC <: Term with Subs[HC], H <: Term with Subs[
          H], HR <: Term with Subs[HR], HI <: Term with Subs[HI], Fb <: Term with Subs[
          Fb], Index <: HList : Subst, IF <: Term with Subs[IF], IDF <: Term with Subs[
          IDF], IDFT <: Term with Subs[IDFT]](
      implicit head: IndexedConstructorPatternMapper[HShape,
                                                     Cod,
                                                     HC,
