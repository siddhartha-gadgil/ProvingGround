...
object ExprLang{
  ...
  def appln[E: ExprLang] = (fa: (E, E)) => implicitly[ExprLang[E]].appln(fa._1, fa._2)
 
  def lambda[E: ExprLang] = (fa: (E, E)) => implicitly[ExprLang[E]].lambda(fa._1, fa._2)
  
  def pair[E: ExprLang] = (fa: (E, E)) => implicitly[ExprLang[E]].pair(fa._1, fa._2)

  def pairTyp[E: ExprLang] = (fa: (E, E)) => implicitly[ExprLang[E]].pairTyp(fa._1, fa._2)

  
  def equality[E: ExprLang] = (fa: (E, E)) => implicitly[ExprLang[E]].equality(fa._1, fa._2)
  
  def pi[E: ExprLang] = (fa: (E, E)) => implicitly[ExprLang[E]].pi(fa._1, fa._2)
  
  def sigma[E: ExprLang] = (fa: (E, E)) => implicitly[ExprLang[E]].sigma(fa._1, fa._2)
  
  def or[E: ExprLang] = (fa: (E, E)) => implicitly[ExprLang[E]].or(fa._1, fa._2)
  ...
  def variable[E: ExprLang] = (nt : (String, E)) => implicitly[ExprLang[E]].variable(nt._1, nt._2)
  ...
  def applnQ[E : ExprLang](func: E, arg: E): Option[E] = {
    ...
    (func, arg) match {
      case (_, All(x)) => 
        Try(applnQ(func, x.asInstanceOf[E]) flatMap (lang.lambda(x.asInstanceOf[E], _))).toOption.flatten
      case (_, Exists(x)) => 
        Try(applnQ(func, x.asInstanceOf[E]) flatMap (lang.sigma(x.asInstanceOf[E], _))).toOption.flatten
      case (All(x),_) =>
