...
abstract class IndexedConstructorPatternMap[Cod <: Term with Subs[Cod], ConstructorType <: Term with Subs[ConstructorType], H <: Term with Subs[H], RecDataType <: Term with Subs[RecDataType], InducDataType <: Term with Subs[InducDataType], Fb <: Term with Subs[Fb], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]] { self =>
  ...
  def subs(x: Term, y: Term): IndexedConstructorPatternMap[Cod, ConstructorType, H, RecDataType, InducDataType, Fb, Index, IF, IDF, IDFT]
...
object IndexedConstructorPatternMap {
  case class IndexedIdMap[C <: Term with Subs[C], H <: Term with Subs[H], Fb <: Term with Subs[Fb], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    family: TypFamilyMap[H, Fb, C, Index, IF, IDF, IDFT],
    index: Index)
    extends IndexedConstructorPatternMap[C, H, H, C, C, Fb, Index, IF, IDF, IDFT] {
  ...
  case class IndexedFuncPtnMap[C <: Term with Subs[C], F <: Term with Subs[F], HC <: Term with Subs[HC], H <: Term with Subs[H], HR <: Term with Subs[HR], HI <: Term with Subs[HI], TT <: Term with Subs[TT], DT <: Term with Subs[DT], Fb <: Term with Subs[Fb], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    tail: IterFuncPtnMap[H, C, F, TT, DT],
    head: IndexedConstructorPatternMap[C, HC, H, HR, HI, Fb, Index, IF, IDF, IDFT],
    ind: Index) extends IndexedRecursiveConstructorPatternMap[C, F, HC, Func[F, HC], H, Func[F, Func[TT, HR]], FuncLike[F, Func[DT, HI]], HR, HI, Fb, Index, IF, IDF, IDFT] { self =>
  ...
  case class IndexedIndexedFuncPtnMap[C <: Term with Subs[C], F <: Term with Subs[F], HC <: Term with Subs[HC], H <: Term with Subs[H], HR <: Term with Subs[HR], HI <: Term with Subs[HI], TT <: Term with Subs[TT], DT <: Term with Subs[DT], Fb <: Term with Subs[Fb], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
  ...
  case class IndexedCnstFncPtnMap[T <: Term with Subs[T], Cod <: Term with Subs[Cod], HC <: Term with Subs[HC], H <: Term with Subs[H], HR <: Term with Subs[HR], HI <: Term with Subs[HI], Fb <: Term with Subs[Fb], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    tail: Typ[T],
    head: IndexedConstructorPatternMap[Cod, HC, H, HR, HI, Fb, Index, IF, IDF, IDFT]) extends IndexedRecursiveConstructorPatternMap[Cod, T, HC, Func[T, HC], H, Func[T, HR], FuncLike[T, HI], HR, HI, Fb, Index, IF, IDF, IDFT] { self =>
  ...
  case class IndexedCnstDepFncPtnMap[T <: Term with Subs[T], Cod <: Term with Subs[Cod], HC <: Term with Subs[HC], H <: Term with Subs[H], HR <: Term with Subs[HR], HI <: Term with Subs[HI], Fb <: Term with Subs[Fb], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    tail: Typ[T],
    headfibre: T => IndexedConstructorPatternMap[Cod, HC, H, HR, HI, Fb, Index, IF, IDF, IDFT]) extends IndexedRecursiveConstructorPatternMap[Cod, T, HC, FuncLike[T, HC], H, FuncLike[T, HR], FuncLike[T, HI], HR, HI, Fb, Index, IF, IDF, IDFT] { self =>
 ...
 *
 */
abstract class IndexedConstructorShape[S <: HList, H <: Term with Subs[H], Fb <: Term with Subs[Fb], ConstructorType <: Term with Subs[ConstructorType], Index <: HList: TermList] {
   ...
   */
  def mapper[C <: Term with Subs[C], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    implicit
    fmlyMapper: TypFamilyMapper[H, Fb, C, Index, IF, IDF, IDFT]): IndexedConstructorPatternMapper[S, C, ConstructorType, H, RecDataType, InducDataType, Fb, Index, IF, IDF, IDFT] forSome {
   ...
   */
  def mapped[C <: Term with Subs[C], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    implicit
    fmlyMapper: TypFamilyMapper[H, Fb, C, Index, IF, IDF, IDFT]) =
...
object IndexedConstructorShape {
  def get[H <: Term with Subs[H], F <: Term with Subs[F], Index <: HList: TermList](
    w: F,
    typ: Typ[H])(implicit g: TypFamilyPtnGetter[F, H, Index]) = {
    val family = g.get(w)
  ...
  case class IndexedIdShape[H <: Term with Subs[H], F <: Term with Subs[F], Index <: HList: TermList](
    ...
    def mapper[C <: Term with Subs[C], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
      implicit
      fmlyMapper: TypFamilyMapper[H, F, C, Index, IF, IDF, IDFT]): IndexedConstructorPatternMapper[HNil, C, H, H, RecDataType, InducDataType, F, Index, IF, IDF, IDFT] forSome {
      type RecDataType <: Term with Subs[RecDataType];
      type InducDataType <: Term with Subs[InducDataType];
    } = fmlyMapper match {
  ...
  case class IndexedFuncConsShape[HShape <: HList, H <: Term with Subs[H], F <: Term with Subs[F], FI <: Term with Subs[FI], HC <: Term with Subs[HC], Index <: HList: TermList](
    tail: IterFuncShape[H, FI],
    head: IndexedConstructorShape[HShape, H, F, HC, Index],
    ind: Index) extends IndexedConstructorShape[IndexedFuncConsShape.type :: HShape, H, F, Func[FI, HC], Index] {
    ...
    def mapper[C <: Term with Subs[C], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
      implicit
      fmlyMapper: TypFamilyMapper[H, F, C, Index, IF, IDF, IDFT]): IndexedConstructorPatternMapper[IndexedFuncConsShape.type :: HShape, C, Func[FI, HC], H, RecDataType, InducDataType, F, Index, IF, IDF, IDFT] forSome {
      type RecDataType <: Term with Subs[RecDataType];
      type InducDataType <: Term with Subs[InducDataType];
    } =
      indexedFuncPtnMap(
        implicitly[TermList[Index]],
        tail.mapper[C],
  ...
  case class IndexedIndexedFuncConsShape[HShape <: HList, H <: Term with Subs[H], F <: Term with Subs[F], HC <: Term with Subs[HC], Fb <: Term with Subs[Fb], Index <: HList: TermList](
    tail: IndexedIterFuncShape[H, F, Fb, Index],
    head: IndexedConstructorShape[HShape, H, Fb, HC, Index],
    ind: Index) extends IndexedConstructorShape[IndexedIndexedFuncConsShape.type :: HShape, H, Fb, Func[F, HC], Index] {
    ...
    def mapper[C <: Term with Subs[C], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
      implicit
      fmlyMapper: TypFamilyMapper[H, Fb, C, Index, IF, IDF, IDFT]): IndexedConstructorPatternMapper[IndexedIndexedFuncConsShape.type :: HShape, C, Func[F, HC], H, RecDataType, InducDataType, Fb, Index, IF, IDF, IDFT] forSome {
      type RecDataType <: Term with Subs[RecDataType];
      type InducDataType <: Term with Subs[InducDataType];
    } =
      indexedIndexedFuncPtnMap(
  ...
  case class IndexedCnstFuncConsShape[HShape <: HList, T <: Term with Subs[T], H <: Term with Subs[H], F <: Term with Subs[F], HC <: Term with Subs[HC], Index <: HList: TermList](
    tail: Typ[T],
    head: IndexedConstructorShape[HShape, H, F, HC, Index]) extends IndexedConstructorShape[IndexedCnstFuncConsShape.type :: HShape, H, F, Func[T, HC], Index] {
    ...
    def mapper[C <: Term with Subs[C], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
      implicit
      fmlyMapper: TypFamilyMapper[H, F, C, Index, IF, IDF, IDFT]): IndexedConstructorPatternMapper[IndexedCnstFuncConsShape.type :: HShape, C, Func[T, HC], H, RecDataType, InducDataType, F, Index, IF, IDF, IDFT] forSome {
      type RecDataType <: Term with Subs[RecDataType];
      type InducDataType <: Term with Subs[InducDataType];
    } =
  ...
  case class IndexedCnstDepFuncConsShape[HShape <: HList, T <: Term with Subs[T], H <: Term with Subs[H], F <: Term with Subs[F], HC <: Term with Subs[HC], Index <: HList: TermList](
    tail: Typ[T],
    headfibre: T => IndexedConstructorShape[HShape, H, F, HC, Index]) extends IndexedConstructorShape[IndexedCnstDepFuncConsShape.type :: HShape, H, F, FuncLike[T, HC], Index] {
    def apply(W: F) = {
      val a = tail.Var
      piDefn(a)(headfibre(a)(W))
    }
 ...
 */
abstract class IndexedConstructorPatternMapper[S <: HList, Cod <: Term with Subs[Cod], ConstructorType <: Term with Subs[ConstructorType], H <: Term with Subs[H], RecDataType <: Term with Subs[RecDataType], InducDataType <: Term with Subs[InducDataType], F <: Term with Subs[F], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]] {
  def mapper(
    implicit
    fmlyMapper: TypFamilyMapper[H, F, Cod, Index, IF, IDF, IDFT]): IndexedConstructorShape[S, H, F, ConstructorType, Index] => IndexedConstructorPatternMap[Cod, ConstructorType, H, RecDataType, InducDataType, F, Index, IF, IDF, IDFT]
}
...
object IndexedConstructorPatternMapper {
  ...
  implicit def indexedIdMapper[C <: Term with Subs[C], H <: Term with Subs[H], F <: Term with Subs[F], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    implicit
    family: TypFamilyMapper[H, F, C, Index, IF, IDF, IDFT]) =
    new IndexedConstructorPatternMapper[HNil, C, H, H, C, C, F, Index, IF, IDF, IDFT] {
      def mapper(implicit fmlyMapper: TypFamilyMapper[H, F, C, Index, IF, IDF, IDFT]) = {
        case IndexedIdShape(fam, ind) =>
          IndexedIdMap(fmlyMapper.mapper(fam), ind)
      }
    }

  implicit def indexedFuncPtnMap[HShape <: HList, C <: Term with Subs[C], F <: Term with Subs[F], FI <: Term with Subs[FI], HC <: Term with Subs[HC], H <: Term with Subs[H], HR <: Term with Subs[HR], HI <: Term with Subs[HI], TT <: Term with Subs[TT], DT <: Term with Subs[DT], Fb <: Term with Subs[Fb], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    implicit
    tail: IterFuncMapper[H, C, FI, TT, DT],
    head: IndexedConstructorPatternMapper[HShape, C, HC, H, HR, HI, Fb, Index, IF, IDF, IDFT]) =
    new IndexedConstructorPatternMapper[IndexedFuncConsShape.type :: HShape, C, Func[FI, HC], H, Func[FI, Func[TT, HR]], FuncLike[FI, Func[DT, HI]], Fb, Index, IF, IDF, IDFT] {
      def mapper(implicit fmlyMapper: TypFamilyMapper[H, Fb, C, Index, IF, IDF, IDFT]) = {
        case IndexedFuncConsShape(t, h, ind) =>
          IndexedFuncPtnMap(tail.mapper(t), head.mapper(fmlyMapper)(h), ind)
      }
    }

  implicit def indexedIndexedFuncPtnMap[HShape <: HList, C <: Term with Subs[C], F <: Term with Subs[F], HC <: Term with Subs[HC], H <: Term with Subs[H], HR <: Term with Subs[HR], HI <: Term with Subs[HI], TT <: Term with Subs[TT], DT <: Term with Subs[DT], Fb <: Term with Subs[Fb], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    implicit
    tail: IndexedIterFuncPtnMapper[H, Fb, Index, C, F, TT, DT, IF, IDF, IDFT],
    head: IndexedConstructorPatternMapper[HShape, C, HC, H, HR, HI, Fb, Index, IF, IDF, IDFT]) =
    new IndexedConstructorPatternMapper[IndexedIndexedFuncConsShape.type :: HShape, C, Func[F, HC], H, Func[F, Func[TT, HR]], FuncLike[F, Func[DT, HI]], Fb, Index, IF, IDF, IDFT] {
      def mapper(implicit fmlyMapper: TypFamilyMapper[H, Fb, C, Index, IF, IDF, IDFT]) = {
        case IndexedIndexedFuncConsShape(t, h, ind) =>
          IndexedIndexedFuncPtnMap(
            tail.mapper(fmlyMapper)(t),
            head.mapper(fmlyMapper)(h),
            ind)
      }
    }

  implicit def indexedCnstFncPtnMapper[HShape <: HList, T <: Term with Subs[T], Cod <: Term with Subs[Cod], HC <: Term with Subs[HC], H <: Term with Subs[H], HR <: Term with Subs[HR], HI <: Term with Subs[HI], Fb <: Term with Subs[Fb], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    implicit
    head: IndexedConstructorPatternMapper[HShape, Cod, HC, H, HR, HI, Fb, Index, IF, IDF, IDFT]) =
    new IndexedConstructorPatternMapper[IndexedCnstFuncConsShape.type :: HShape, Cod, Func[T, HC], H, Func[T, HR], FuncLike[T, HI], Fb, Index, IF, IDF, IDFT] {
      def mapper(
        implicit
        fmlyMapper: TypFamilyMapper[H, Fb, Cod, Index, IF, IDF, IDFT]) = {
        case IndexedCnstFuncConsShape(t, h) =>
          IndexedCnstFncPtnMap(t, head.mapper(fmlyMapper)(h))
      }
    }

  implicit def indexedCnstDepFncPtnMapper[HShape <: HList, T <: Term with Subs[T], Cod <: Term with Subs[Cod], HC <: Term with Subs[HC], H <: Term with Subs[H], HR <: Term with Subs[HR], HI <: Term with Subs[HI], Fb <: Term with Subs[Fb], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    implicit
    head: IndexedConstructorPatternMapper[HShape, Cod, HC, H, HR, HI, Fb, Index, IF, IDF, IDFT]) =
    new IndexedConstructorPatternMapper[IndexedCnstDepFuncConsShape.type :: HShape, Cod, FuncLike[T, HC], H, FuncLike[T, HR], FuncLike[T, HI], Fb, Index, IF, IDF, IDFT] {
      def mapper(
        implicit
        fmlyMapper: TypFamilyMapper[H, Fb, Cod, Index, IF, IDF, IDFT]) = {
...
case class IndexedConstructor[S <: HList, H <: Term with Subs[H], F <: Term with Subs[F], ConstructorType <: Term with Subs[ConstructorType], Index <: HList: TermList](
  name: AnySym,
