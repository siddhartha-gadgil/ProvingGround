 ...
 *
 */
abstract class IndexedConstructorSeqMap[C <: Term with Subs[C], H <: Term with Subs[H], RecType <: Term with Subs[RecType], InducType <: Term with Subs[InducType], Intros <: HList, F <: Term with Subs[F], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]] {
...
object IndexedConstructorSeqMap {
  case class Empty[C <: Term with Subs[C], H <: Term with Subs[H], F <: Term with Subs[F], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    W: F,
    family: TypFamilyMap[H, F, C, Index, IF, IDF, IDFT])
    extends IndexedConstructorSeqMap[C, H, IF, IDF, HNil, F, Index, IF, IDF, IDFT] {
  ...
  case class Cons[C <: Term with Subs[C], H <: Term with Subs[H], Cod <: Term with Subs[Cod], RD <: Term with Subs[RD], ID <: Term with Subs[ID], TR <: Term with Subs[TR], TI <: Term with Subs[TI], TIntros <: HList, F <: Term with Subs[F], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    cons: C,
    pattern: IndexedConstructorPatternMap[Cod, C, H, RD, ID, F, Index, IF, IDF, IDFT],
    tail: IndexedConstructorSeqMap[Cod, H, TR, TI, TIntros, F, Index, IF, IDF, IDFT]) extends IndexedConstructorSeqMap[Cod, H, Func[RD, TR], Func[ID, TI], C :: TIntros, F, Index, IF, IDF, IDFT] {
    ...
    def dataCons(X: Typ[Cod]): IndexedRecursiveDefinition.DataCons[H, F, Cod, Index, IF, IDF, IDFT, RD] =
 ...
 */
abstract class IndexedConstructorSeqMapper[SS <: HList, C <: Term with Subs[C], H <: Term with Subs[H], RecType <: Term with Subs[RecType], InducType <: Term with Subs[InducType], Intros <: HList, F <: Term with Subs[F], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]] {
  def mapped(seqdom: IndexedConstructorSeqDom[SS, H, F, Index, Intros])(
    W: F,
    family: TypFamilyPtn[H, F, Index]): IndexedConstructorSeqMap[C, H, RecType, InducType, Intros, F, Index, IF, IDF, IDFT]
}

object IndexedConstructorSeqMapper {
  implicit def empty[H <: Term with Subs[H], C <: Term with Subs[C], F <: Term with Subs[F], Index <: HList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    implicit
    subst: TermList[Index],
    fmlyMapper: TypFamilyMapper[H, F, C, Index, IF, IDF, IDFT]) =
    new IndexedConstructorSeqMapper[HNil, C, H, IF, IDF, HNil, F, Index, IF, IDF, IDFT] {
  ...
  implicit def cons[TSS <: HList, HShape <: HList, H <: Term with Subs[H], Cod <: Term with Subs[Cod], ConstructorType <: Term with Subs[ConstructorType], TIntros <: HList, RD <: Term with Subs[RD], ID <: Term with Subs[ID], TR <: Term with Subs[TR], TI <: Term with Subs[TI], F <: Term with Subs[F], Index <: HList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    implicit
    patternMapper: IndexedConstructorPatternMapper[HShape, Cod, ConstructorType, H, RD, ID, F, Index, IF, IDF, IDFT],
    tailMapper: IndexedConstructorSeqMapper[TSS, Cod, H, TR, TI, TIntros, F, Index, IF, IDF, IDFT],
    subst: TermList[Index],
    fmlyMapper: TypFamilyMapper[H, F, Cod, Index, IF, IDF, IDFT]): IndexedConstructorSeqMapper[HShape :: TSS, Cod, H, Func[RD, TR], Func[ID, TI], ConstructorType :: TIntros, F, Index, IF, IDF, IDFT] =
    new IndexedConstructorSeqMapper[HShape :: TSS, Cod, H, Func[RD, TR], Func[ID, TI], ConstructorType :: TIntros, F, Index, IF, IDF, IDFT] {
      def mapped(seqdom: IndexedConstructorSeqDom[HShape :: TSS, H, F, Index, ConstructorType :: TIntros])(
        W: F,
        family: TypFamilyPtn[H, F, Index]) =
        seqdom match {
 ...
 *
 */
abstract class IndexedConstructorSeqDom[SS <: HList, H <: Term with Subs[H], F <: Term with Subs[F], Index <: HList: TermList, Intros <: HList] {
  ...
  def mapped[C <: Term with Subs[C], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    implicit
    fmlyMapper: TypFamilyMapper[H, F, C, Index, IF, IDF, IDFT]): IndexedConstructorSeqMap[C, H, RecType, InducType, Intros, F, Index, IF, IDF, IDFT] forSome {
    type RecType <: Term with Subs[RecType];
    type InducType <: Term with Subs[InducType];
  }
   ...
   */
  def rec[C <: Term with Subs[C], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT], RecType <: Term with Subs[RecType], InducType <: Term with Subs[InducType]](X: Typ[C])(
    implicit
    mapper: IndexedConstructorSeqMapper[SS, C, H, RecType, InducType, Intros, F, Index, IF, IDF, IDFT]) = mapper.mapped(this)(W, family).rec(X)

  def getInduc[C <: Term with Subs[C], IDFT <: Term with Subs[IDFT], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], RecType <: Term with Subs[RecType], InducType <: Term with Subs[InducType]](X: Typ[C])(
    implicit
    mapper: IndexedConstructorSeqMapper[SS, C, H, RecType, InducType, Intros, F, Index, IF, IDF, IDFT]) = mapper.mapped(this)(W, family).induc(_)

  def getMapper[C <: Term with Subs[C], IDFT <: Term with Subs[IDFT], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], RecType <: Term with Subs[RecType], InducType <: Term with Subs[InducType]](X: Typ[C])(
    implicit
    mapper: IndexedConstructorSeqMapper[SS, C, H, RecType, InducType, Intros, F, Index, IF, IDF, IDFT]) = mapper.mapped(this)(W, family)

  /**
   * induction function based on implicits
   */
  def induc[IDFT <: Term with Subs[IDFT], C <: Term with Subs[C], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], RecType <: Term with Subs[RecType], InducType <: Term with Subs[InducType]](Xs: IDFT)(
    implicit
    mapper: IndexedConstructorSeqMapper[SS, C, H, RecType, InducType, Intros, F, Index, IF, IDF, IDFT]) = mapper.mapped(this)(W, family).induc(Xs)
...
object IndexedConstructorSeqDom {
  ...
  case class Empty[H <: Term with Subs[H], F <: Term with Subs[F], Index <: HList: TermList](
    W: F,
    family: TypFamilyPtn[H, F, Index])
    extends IndexedConstructorSeqDom[HNil, H, F, Index, HNil] {
    def mapped[C <: Term with Subs[C], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
      implicit
      fmlyMapper: TypFamilyMapper[H, F, C, Index, IF, IDF, IDFT]) // : IndexedConstructorSeqMap[C,
      //                            H,
      //                            RecType,
      //                            InducType,
      //                            HNil,
  ...
  case class Cons[TSS <: HList, HShape <: HList, H <: Term with Subs[H], F <: Term with Subs[F], HC <: Term with Subs[HC], Index <: HList: TermList, TIntro <: HList](
    name: AnySym,
    ...
    def mapped[C <: Term with Subs[C], IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
      implicit
      fmlyMapper: TypFamilyMapper[H, F, C, Index, IF, IDF, IDFT]): IndexedConstructorSeqMap[C, H, RecType, InducType, HC :: TIntro, F, Index, IF, IDF, IDFT] forSome {
      type RecType <: Term with Subs[RecType];
      type InducType <: Term with Subs[InducType];
    } =
      IndexedConstructorSeqMap.Cons(
