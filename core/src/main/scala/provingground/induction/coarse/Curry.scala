...
object Curry {
  ...
  implicit def funcCurry[Dom <: Term with Subs[Dom], Iter <: Term with Subs[Iter], Total <: Term with Subs[Total], Cod <: Term with Subs[Cod]](
    implicit
    base: Curry[Iter, Total, Cod]): Curry[Func[Dom, Iter], PairTerm[Dom, Total], Cod] =
