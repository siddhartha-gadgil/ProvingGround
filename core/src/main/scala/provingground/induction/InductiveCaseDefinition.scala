...
object InductiveDefinition {
  ...
  case class Empty[H <: Term with Subs[H], C <: Term with Subs[C]](
    fibre: Func[H, Typ[C]]) extends InductiveDefinition[H, C] {
  ...
  case class DataCons[H <: Term with Subs[H], C <: Term with Subs[C], D <: Term with Subs[D]](
    ...
    replacement: Term => Term => Func[H, Typ[C]] => Option[DataCons[H, C, D]] = (_: Term) => (_: Term) => (_: Func[H, Typ[C]]) => None) extends InductiveDefinition[H, C] {
    val typ = tail.typ
 ...
 */
abstract class IndexedInductiveDefinition[H <: Term with Subs[H], F <: Term with Subs[F], C <: Term with Subs[C], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]] {
  self =>
...
object IndexedInductiveDefinition {
  case class Empty[H <: Term with Subs[H], F <: Term with Subs[F], C <: Term with Subs[C], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT]](
    W: F,
    Xs: IDFT,
    family: TypFamilyMap[H, F, C, Index, IF, IDF, IDFT]) extends IndexedInductiveDefinition[H, F, C, Index, IF, IDF, IDFT] {
  ...
  case class DataCons[H <: Term with Subs[H], F <: Term with Subs[F], C <: Term with Subs[C], Index <: HList: TermList, IF <: Term with Subs[IF], IDF <: Term with Subs[IDF], IDFT <: Term with Subs[IDFT], D <: Term with Subs[D]](
    ...
    replacement: Term => Term => IDFT => Option[DataCons[H, F, C, Index, IF, IDF, IDFT, D]] = (_: Term) =>
      (_: Term) => (_: IDFT) => None) extends IndexedInductiveDefinition[H, F, C, Index, IF, IDF, IDFT] {
