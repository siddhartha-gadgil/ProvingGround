...
/**
  * Solve equations based on expressions (approximately), and compute various related quantities
  * The actual solving is done after translating the equations to ones based on indices, for the sake of efficiency.
  * Other methods let one construct new expression-equation-solvers, including by export.
  */
trait ExpressionEquationSolver { self =>
  ...
  /**
    ...
    *
    * @return indexed-equation-solver with the correct parameters
    */
  ...
  lazy val Final: FixedExpressionProbs = FixedExpressionProbs(finalDist)
...
object ExpressionEquationSolver {
  ...
  /**
    ...
    * @return [[ExpressionEquationSolver]] built
    */
  def fromStates(
      initialState: TermState,
  ...
  /**
    * builds an [[ExpressionEquationSolver]] given initial states, equations and parameters,
  ...
  /**
    ...
    * @return exported [[ExpressionEquationSolver]]
    */
