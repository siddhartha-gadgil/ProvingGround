...
indNV: provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.FuncLike[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Term]],provingground.HoTT.FuncLike[provingground.HoTT.Term,provingground.HoTT.Term]]] = (InducDataSym(0) :  (Vec) (0)) ↦ ((InducDataSym(succ) :  $gfisj ~> ((Vec) ($gfisj)) → ((Vec) ((succ) ($gfisj)))) ↦ (ind(Nat)(Vec)(InducDataSym(0))(InducDataSym(succ))))
...
inducDoubleEven: provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.FuncLike[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Term]],provingground.HoTT.FuncLike[provingground.HoTT.Term,provingground.HoTT.Term]]] = (InducDataSym(0) :  (isEven) (0)) ↦ ((InducDataSym(succ) :  $hiyeb ~> ((isEven) ((rec(Nat)(Nat)(0)((_ :  Nat) ↦ ((n :  Nat) ↦ ((succ) ((succ) (n)))))) ($hiyeb))) → ((isEven) ((succ) ((succ) ((rec(Nat)(Nat)(0)((_ :  Nat) ↦ ((n :  Nat) ↦ ((succ) ((succ) (n)))))) ($hiyeb)))))) ↦ (ind(Nat)((n :  Nat) ↦ ((isEven) ((rec(Nat)(Nat)(0)((_ :  Nat) ↦ ((n :  Nat) ↦ ((succ) ((succ) (n)))))) (n))))(InducDataSym(0))(InducDataSym(succ))))
...
inducSuccEven: provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.FuncLike[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Term]],provingground.HoTT.FuncLike[provingground.HoTT.Term,provingground.HoTT.Term]]] = (InducDataSym(0) :  PlusTyp((isEven) (0),(isEven) ((succ) (0)))) ↦ ((InducDataSym(succ) :  $hkhzo ~> (PlusTyp((isEven) ($hkhzo),(isEven) ((succ) ($hkhzo)))) → (PlusTyp((isEven) ((succ) ($hkhzo)),(isEven) ((succ) ((succ) ($hkhzo)))))) ↦ (ind(Nat)((n :  Nat) ↦ (PlusTyp((isEven) (n),(isEven) ((succ) (n)))))(InducDataSym(0))(InducDataSym(succ))))
...
step: provingground.HoTT.Func[provingground.HoTT.Equality[provingground.HoTT.Term] with provingground.HoTT.Subs[provingground.HoTT.Equality[provingground.HoTT.Term]],provingground.HoTT.Equality[provingground.HoTT.Term with provingground.HoTT.Subs[provingground.HoTT.Term]]] = (hypothesis : ((f) (0) = (f) (n)) :  (f) (0) = (f) (n)) ↦ (((ind{($hlbem :  A) ↦ (($hlben :  A) ↦ ($hlbem = $hlben))((f) (0))((f) (n))}{($hkyip :  A) ↦ (($hkyiq :  A) ↦ ((_ : ($hkyip = $hkyiq) :  $hkyip = $hkyiq) ↦ (($hkyiq = (f) ((succ) (n))) → ($hkyip = (f) ((succ) (n))))))}(($hkyip :  A) ↦ (($hkyxf : ($hkyip = (f) ((succ) (n))) :  $hkyip = (f) ((succ) (n))) ↦ ($hkyxf : ($hkyip = (f) ((succ) (n))))))) (hypothesis : ((f) (0) = (f) (n)))) ((assumption) (n) : ((f) (n) = (f) ((succ) (n)))) : ...

scala> val inducClaim = NatInd.induc(claim)
inducClaim: provingground.HoTT.Func[provingground.HoTT.Equality[provingground.HoTT.Term],provingground.HoTT.Func[provingground.HoTT.FuncLike[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Equality[provingground.HoTT.Term],provingground.HoTT.Equality[provingground.HoTT.Term]]],provingground.HoTT.FuncLike[provingground.HoTT.Term,provingground.HoTT.Equality[provingground.HoTT.Term]]]] = (InducDataSym(0) : ((f) (0) = (f) (0)) :  (f) (0) = (f) (0)) ↦ ((InducDataSym(succ) :  $hlbgx ~> ((f) (0) = (f) ($hlbgx)) → ((f) (0) = (f) ((succ) ($hlbgx)))) ↦ (ind(Nat)((n :  Nat) ↦ ((f) (0) = (f) (n)))(InducDataSym(0) : ((f) (0) = (f) (0)))(InducDataSym(succ))))

scala> val pf = inducClaim(base)(n :~> step) !: (n ~>: (f(zero) =:= f(n)))
pf: provingground.HoTT.FuncLike[provingground.HoTT.Term with provingground.HoTT.Subs[provingground.HoTT.Term],provingground.HoTT.Equality[provingground.HoTT.Term]] = ind(Nat)((n :  Nat) ↦ ((f) (0) = (f) (n)))(Refl(A,(f) (0)))((n :  Nat) ↦ ((hypothesis : ((f) (0) = (f) (n)) :  (f) (0) = (f) (n)) ↦ (((ind{($hlgus :  A) ↦ (($hlgut :  A) ↦ ($hlgus = $hlgut))((f) (0))((f) (n))}{($hkyip :  A) ↦ (($hkyiq :  A) ↦ ((_ : ($hkyip = $hkyiq) :  $hkyip = $hkyiq) ↦ (($hkyiq = (f) ((succ) (n))) → ($hkyip = (f) ((succ) (n))))))}(($hkyip :  A) ↦ (($hkyxf : ($hkyip = (f) ((succ) (n))) :  $hkyip = (f) ((succ) (n))) ↦ ($hkyxf : ($hkyip = (f) ((succ) (n))))))) (hypothesis : ((f) (0) = (f) (n)))) ((assumption) (n) : ((f) (n) = (f) ((succ) (n)))) : ((f) (0) = (f) ((succ) (n))))))
```
...
scala> val VecInd =
     ...
     |   } =:: Vec
VecInd: provingground.induction.IndexedConstructorSeqDom.Cons[(provingground.induction.IndexedConstructorShape.IndexedCnstDepFuncConsShape.type :: provingground.induction.IndexedConstructorShape.IndexedCnstFuncConsShape.type :: provingground.induction.IndexedConstructorShape.IndexedIndexedFuncConsShape.type :: shapeless.HNil) :: shapeless.HNil,shapeless.HNil,provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Typ[provingground.HoTT.Term]] with provingground.HoTT.Subs[provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Typ[provingground.HoTT.Term]]],provingground.HoTT.Term,provingground.HoTT.Term :: shapeless.HNil,provingground.HoTT.FuncLike[provingground.HoTT.Term with provingground.HoTT.Subs[provingground.HoTT....
...
res45: String = ∏($hllod : Nat){ (A → (Vec($hllod) → Vec(succ($hllod)))) }
```
...
recVN: provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.FuncLike[provingground.HoTT.Term with provingground.HoTT.Subs[provingground.HoTT.Term],provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Term]]]],provingground.HoTT.FuncLike[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Term]]]] = (RecDataSym(nil) :  Nat) ↦ ((RecDataSym(cons) :  $hllpb ~> (A) → (((Vec) ($hllpb)) → ((Nat) → (Nat)))) ↦ (($hllok :  Nat) ↦ (rec{Vec($hllok)}{Nat}(RecDataSym(nil))(RecDataSym(cons)))))

scala> val size = recVN(zero)(n :~>(a :-> (vn :->(m :->(succ(m))))))
size: provingground.HoTT.FuncLike[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Term]] = ($hllok :  Nat) ↦ (rec{Vec($hllok)}{Nat}(0)((n :  Nat) ↦ ((_ :  A) ↦ ((_ :  (Vec) (n)) ↦ ((m :  Nat) ↦ ((succ) (m)))))))
...
scala> val VecNInd =
     ...
     |   } =:: VecN
VecNInd: provingground.induction.IndexedConstructorSeqDom.Cons[(provingground.induction.IndexedConstructorShape.IndexedCnstDepFuncConsShape.type :: provingground.induction.IndexedConstructorShape.IndexedCnstFuncConsShape.type :: provingground.induction.IndexedConstructorShape.IndexedIndexedFuncConsShape.type :: shapeless.HNil) :: shapeless.HNil,shapeless.HNil,provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Typ[provingground.HoTT.Term]] with provingground.HoTT.Subs[provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Typ[provingground.HoTT.Term]]],provingground.HoTT.Term,provingground.HoTT.Term :: shapeless.HNil,provingground.HoTT.FuncLike[provingground.HoTT.Term with provingground.HoTT.Subs[provingground.HoTT...

scala> val recVNN                  = VecNInd.rec(Nat)
recVNN: provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.FuncLike[provingground.HoTT.Term with provingground.HoTT.Subs[provingground.HoTT.Term],provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Term]]]],provingground.HoTT.FuncLike[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Term]]]] = (RecDataSym(nil) :  Nat) ↦ ((RecDataSym(cons) :  $hlohh ~> (Nat) → (((Vec(Nat)) ($hlohh)) → ((Nat) → (Nat)))) ↦ (($hlogq :  Nat) ↦ (rec{Vec(Nat)($hlogq)}{Nat}(RecDataSym(nil))(RecDataSym(cons)))))
...
vsum: provingground.HoTT.FuncLike[provingground.HoTT.Term,provingground.HoTT.Func[provingground.HoTT.Term,provingground.HoTT.Term]] = ($hlogq :  Nat) ↦ (rec{Vec(Nat)($hlogq)}{Nat}(0)((n :  Nat) ↦ ((k :  Nat) ↦ ((_ :  (Vec(Nat)) (n)) ↦ ((m :  Nat) ↦ (((rec(Nat)((Nat) → (Nat))((m :  Nat) ↦ (m))((_ :  Nat) ↦ ((add(n) :  (Nat) → (Nat)) ↦ ((m :  Nat) ↦ ((succ) ((add(n)) (m))))))) (m)) (k)))))))
