 ...
 */
  ...
  BoolType.constructors                           //> res38: List[provingGround.HoTT.Constructor] = List(ConstructorDefn(IdW,(tru
                                                  //| e : src.main.scala.HoTTExperiment$$anonfun$main$1$BoolType$2$@481caae8)), C
                                                  //| onstructorDefn(IdW,(provingGround.HoTT$Typ$newname$2$@52188a54 : src.main.s
                                                  //| cala.HoTTExperiment$$anonfun$main$1$BoolType$2$@481caae8)))
 ...
 val List(zero, succ) = NatTyp.constructors       //> zero  : provingGround.HoTT.Constructor = ConstructorDefn(IdW,(provingGround
                                                  //| .HoTT$Typ$newname$2$@67a62feb : src.main.scala.HoTTExperiment$$anonfun$main
                                                  //| $1$NatTyp$2$@4f942276))
                                                  //| succ  : provingGround.HoTT.Constructor = ConstructorDefn(CnstFncPtn(src.mai
                                                  //| n.scala.HoTTExperiment$$anonfun$main$1$NatTyp$2$@4f942276,IdW),(provingGrou
                                                  //| nd.HoTT$Typ$newname$2$@66299cb : (src.main.scala.HoTTExperiment$$anonfun$ma
                                                  //| in$1$NatTyp$2$@4f942276⟶src.main.scala.HoTTExperiment$$anonfun$main$1$Nat
                                                  //| Typ$2$@4f942276)))
 succ.cons.typ                                    //> res39: provingGround.HoTT.Typ[provingGround.HoTT.Term] = (src.main.scala.Ho
                                                  //| TTExperiment$$anonfun$main$1$NatTyp$2$@4f942276⟶src.main.scala.HoTTExperi
                                                  //| ment$$anonfun$main$1$NatTyp$2$@4f942276)
}