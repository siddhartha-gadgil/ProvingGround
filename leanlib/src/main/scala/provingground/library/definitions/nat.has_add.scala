...
import Fold._
object nat$has_add {
  lazy val value = ("has_add.mk" :: piDefn("'d_933440192" :: Type)(FuncTyp(FuncTyp("'d_933440192" :: Type, FuncTyp("'d_933440192" :: Type, "'d_933440192" :: Type)), ("has_add" :: FuncTyp(Type, Type))("'d_933440192" :: Type))))("nat" :: Type)(lmbda("'z_924862204" :: "nat" :: Type)(lmbda("'aa_63933964" :: "nat" :: Type)(({
