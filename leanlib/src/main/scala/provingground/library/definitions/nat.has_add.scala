...
import Fold._
object nat$has_add {
  lazy val value = ("has_add.mk" :: piDefn("'d_1188183567" :: Type)(FuncTyp(FuncTyp("'d_1188183567" :: Type, FuncTyp("'d_1188183567" :: Type, "'d_1188183567" :: Type)), ("has_add" :: FuncTyp(Type, Type))("'d_1188183567" :: Type))))("nat" :: Type)(lmbda("'z_404172118" :: "nat" :: Type)(lmbda("'aa_1379847308" :: "nat" :: Type)(({
