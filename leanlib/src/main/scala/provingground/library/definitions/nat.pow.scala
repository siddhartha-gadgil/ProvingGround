...
import Fold._
object nat$pow {
  lazy val value = lmbda("'as_819989894" :: "nat" :: Type)(lmbda("'as_1776667304" :: "nat" :: Type)(({
    ...
    val rxyz = pprodInd.value(FuncTyp("nat" :: Type, "nat" :: Type))(({
      val rxyz = natInd.value.rec(Type)
      rxyz
    })("punit" :: Type)(lmbda("'h_403586353" :: "nat" :: Type)(lmbda("'i_547011919" :: Type)(("pprod" :: FuncTyp(Type, FuncTyp(Type, Type)))(("pprod" :: FuncTyp(Type, FuncTyp(Type, Type)))(FuncTyp("nat" :: Type, "nat" :: Type))("'i_547011919" :: Type))("punit" :: Type))))("'as_819989894" :: "nat" :: Type)).rec(FuncTyp("nat" :: Type, "nat" :: Type))
    rxyz
  })(lmbda("'s_1397176685" :: FuncTyp("nat" :: Type, "nat" :: Type))(lmbda("_" :: ({
    val rxyz = natInd.value.rec(Type)
    rxyz
  })("punit" :: Type)(lmbda("'h_403586353" :: "nat" :: Type)(lmbda("'i_547011919" :: Type)(("pprod" :: FuncTyp(Type, FuncTyp(Type, Type)))(("pprod" :: FuncTyp(Type, FuncTyp(Type, Type)))(FuncTyp("nat" :: Type, "nat" :: Type))("'i_547011919" :: Type))("punit" :: Type))))("'as_819989894" :: "nat" :: Type))("'s_1397176685" :: FuncTyp("nat" :: Type, "nat" :: Type))))(({
    ...
    val rxyz = natInd.value.rec(Type)
    rxyz
  })("punit" :: Type)(lmbda("'h_403586353" :: "nat" :: Type)(lmbda("'i_547011919" :: Type)(("pprod" :: FuncTyp(Type, FuncTyp(Type, Type)))(("pprod" :: FuncTyp(Type, FuncTyp(Type, Type)))(FuncTyp("nat" :: Type, "nat" :: Type))("'i_547011919" :: Type))("punit" :: Type))))("'v_172657575" :: "nat" :: Type)))("punit.star" :: "punit" :: Type)))))("'as_819989894" :: "nat" :: Type))(({
    val rxyz = pprodInd.value("nat" :: Type)(({
      val rxyz = natInd.value.rec(Type)
      rxyz
