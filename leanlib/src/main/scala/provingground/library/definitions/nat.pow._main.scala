...
object nat$pow$_main {
  lazy val value = lmbda("'ar_342253958" :: "nat" :: Type)(lmbda("'as_1291849338" :: "nat" :: Type)(({
    ...
    val rxyz = pprodInd.value(FuncTyp("nat" :: Type, "nat" :: Type))(({
      val rxyz = natInd.value.rec(Type)
      rxyz
    })("punit" :: Type)(lmbda("'h_1573352955" :: "nat" :: Type)(lmbda("'i_830893068" :: Type)(("pprod" :: FuncTyp(Type, FuncTyp(Type, Type)))(("pprod" :: FuncTyp(Type, FuncTyp(Type, Type)))(FuncTyp("nat" :: Type, "nat" :: Type))("'i_830893068" :: Type))("punit" :: Type))))("'ar_342253958" :: "nat" :: Type)).rec(FuncTyp("nat" :: Type, "nat" :: Type))
    rxyz
  })(lmbda("'s_1338792767" :: FuncTyp("nat" :: Type, "nat" :: Type))(lmbda("_" :: ({
    val rxyz = natInd.value.rec(Type)
    rxyz
  })("punit" :: Type)(lmbda("'h_1573352955" :: "nat" :: Type)(lmbda("'i_830893068" :: Type)(("pprod" :: FuncTyp(Type, FuncTyp(Type, Type)))(("pprod" :: FuncTyp(Type, FuncTyp(Type, Type)))(FuncTyp("nat" :: Type, "nat" :: Type))("'i_830893068" :: Type))("punit" :: Type))))("'ar_342253958" :: "nat" :: Type))("'s_1338792767" :: FuncTyp("nat" :: Type, "nat" :: Type))))(({
    ...
    val rxyz = natInd.value.rec(Type)
    rxyz
  })("punit" :: Type)(lmbda("'h_1573352955" :: "nat" :: Type)(lmbda("'i_830893068" :: Type)(("pprod" :: FuncTyp(Type, FuncTyp(Type, Type)))(("pprod" :: FuncTyp(Type, FuncTyp(Type, Type)))(FuncTyp("nat" :: Type, "nat" :: Type))("'i_830893068" :: Type))("punit" :: Type))))("'v_258307798" :: "nat" :: Type)))("punit.star" :: "punit" :: Type)))))("'ar_342253958" :: "nat" :: Type))(({
    val rxyz = pprodInd.value("nat" :: Type)(({
      val rxyz = natInd.value.rec(Type)
      rxyz
